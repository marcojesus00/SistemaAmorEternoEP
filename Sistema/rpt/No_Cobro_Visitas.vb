...
Public Class No_Cobro_Visitas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.No_Cobro_Visitas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNo_Cobro_Visitas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As No_Cobro_Visitas = New No_Cobro_Visitas()
        rpt.Site = Me.Site
        Return rpt
    End Function
