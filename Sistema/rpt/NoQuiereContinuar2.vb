...
Public Class NoQuiereContinuar2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.NoQuiereContinuar2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNoQuiereContinuar2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NoQuiereContinuar2 = New NoQuiereContinuar2()
        rpt.Site = Me.Site
        Return rpt
    End Function
