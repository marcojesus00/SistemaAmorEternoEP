...
Public Class FirmaClientesSPS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.FirmaClientesSPS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFirmaClientesSPS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FirmaClientesSPS = New FirmaClientesSPS()
        rpt.Site = Me.Site
        Return rpt
    End Function
