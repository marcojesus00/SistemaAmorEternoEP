...
Public Class ClientsTable
    ...
    '    Using dbContext As New MyDbContext()
    '        Dim data = dbContext.Contratos.Where(Function(c) c.CodigoCliente.Contains(id)).Select(Function(c) New With {c.Cliente.NombreCliente, c.CodigoCliente, c.Vendedor, c.Cobrador}).OrderBy(Function(c) c.NombreCliente).Take(10)
    '        Return data.ToList()
