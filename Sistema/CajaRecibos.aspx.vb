Public Class CajaRecibos
    ...
    '            Dim Sql As String
    '            Sql = "EXEC ENVIARECIBOS '" + Session("Cobrador") + "' "
    '            conf.EjecutaSql(Sql)
    ...
    '                Sql += " AND A.codigo_cobr + B.nombre_cobr LIKE '%" + txtCobrador.Text + "%'"
    ...
    '            If Usuario_Aut = "MANAGER" And Datos.Tables(0).Rows.Count = 1 And dlMostrar.SelectedIndex = 1 Then
    '                Datos1 = Conf1.EjecutaSql(Sql1)
    '                Session.Add("GVDetalle", Datos1.Tables(0))

    '                Session("GVDetalle").DefaultView.RowFilter = "codigo_cobr='" + txtCobrador.Text + "'"
