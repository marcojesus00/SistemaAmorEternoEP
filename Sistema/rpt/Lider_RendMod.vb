...
Public Class Lider_RendMod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.Lider_RendMod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLider_RendMod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Lider_RendMod = New Lider_RendMod()
        rpt.Site = Me.Site
        Return rpt
    End Function
