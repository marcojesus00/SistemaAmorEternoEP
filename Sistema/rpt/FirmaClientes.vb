...
Public Class FirmaClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.FirmaClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFirmaClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FirmaClientes = New FirmaClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
