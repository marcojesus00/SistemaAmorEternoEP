    ...
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="left">
            <div class="container-fluid" style="padding-top: 5px;">
                ...
                <div>
                    <h4 style="width: 100%; text-align: center">Monitor de Cobros</h4>
                </div>
...
<i class="bi bi-coin"></i> AVANZADO
                ...
                <asp:GridView ID="gvMonitor" runat="server" DataKeyNames="Codigo" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AllowSorting="True">
                ...
                <br />
                <asp:GridView ID="gvMonitor2" runat="server" DataKeyNames="Codigo" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowSorting="True">
                    <Columns>
                    </Columns>
                ...
                <asp:GridView ID="gvDetalle2" runat="server" DataKeyNames="Codigo" AllowSorting="True" Visible="False" CssClass="ChildGrid" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
                    <Columns>
                        ...
                        <asp:BoundField DataField="CONCEPTO" HeaderText="Motivo" ItemStyle-Width="220px" ControlStyle-Font-Size="Small">
                            <ControlStyle Font-Size="Small"></ControlStyle>
                        ...
                        <asp:Table runat="server" Width="100%" HorizontalAlign="Center">
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                                    <h4 class="alert-heading">Anular el recibo:
                                        <asp:Label ID="lblMensaje" runat="server" /></h4>
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center"><b>
                                    <asp:Label ID="lblMensaje1" runat="server" /></b></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">Por Valor de: <b>
                                    <asp:Label ID="lblMensaje2" runat="server" /></b></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="Right">Comentario: </asp:TableCell><asp:TableCell HorizontalAlign="left">
                                    <asp:TextBox runat="server" ID="txtComentario" CssClass="form-control form-control-sm" Height="24" Width="150"></asp:TextBox></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell HorizontalAlign="Right">Clave: </asp:TableCell><asp:TableCell HorizontalAlign="left">
                                    <asp:TextBox runat="server" ID="txtClave" TextMode="Password" CssClass="form-control form-control-sm" Height="24" Width="150"></asp:TextBox></asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                            ...
                            <asp:TableRow>
                                ...
                                <asp:Button runat="server" ID="btnCancelar" Text="Cancelar" CssClass="btn btn-secondary btn-sm" />
                                </asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
                    </div>
