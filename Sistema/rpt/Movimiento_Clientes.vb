...
Public Class Movimiento_Clientes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Movimiento_Clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.Movimiento_Clientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMovimiento_Clientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Movimiento_Clientes = New Movimiento_Clientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
