...
Public Class VentasResindidas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.VentasResindidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentasResindidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasResindidas = New VentasResindidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
