            ...
            <div style="padding-left: 15%; padding-right: 15%; padding-top: 40px;">
                ...
                <div class="row" style="background-color: white">
                    <div class="col-6" id="divClientes" style="background-color: azure">
                        ...
                        <div class="input-group-prepend">
                            <label class="input-group-text" style="width: 100%; background-color:#726e6e;color:aliceblue">Datos del Plan Adquirido</label> </div></div></div><%-- Identidad --%><div class="row" style="background-color: white">
                    <div class="col-6">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
