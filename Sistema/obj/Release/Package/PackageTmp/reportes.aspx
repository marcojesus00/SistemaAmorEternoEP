        ...
        <div class="container-fluid" style="padding-top:5px;">
            <asp:Table ID="Table1" runat="server">
                <asp:TableRow runat="server">
                    ...
                    <asp:TableCell runat="server"><asp:TextBox ID="txtFecha1" runat="server" TextMode="Date" CssClass="form-control form-control-sm" Width="200" Height="26" Font-Size="Small"></asp:TextBox></asp:TableCell>                    
                </asp:TableRow>
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server"><asp:Label ID="Label2" runat="server" Text="Hasta la Fecha:"/></asp:TableCell>
                    <asp:TableCell runat="server"><asp:TextBox ID="txtFecha2" runat="server" TextMode="Date" CssClass="form-control form-control-sm" Width="200" Height="26" Font-Size="Small"></asp:TextBox></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
                ...
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server"><asp:Label ID="Label4" Visible="false" runat="server" Text="Cobrador:" /></asp:TableCell>
                    <asp:TableCell runat="server"><asp:TextBox ID="txtlider" Visible="false" runat="server" CssClass="form-control form-control-sm" Width="200" Height="24" Font-Size="Small"/></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server"><asp:Label ID="Label5" runat="server" Text="Agrupado por:" Visible ="false"/></asp:TableCell>
                    <asp:TableCell runat="server"><asp:DropDownList ID ="dlAgrupa" runat="server" Visible="false" CssClass="form-control form-control-sm" Width="200" Height="27" Font-Size="Small"></asp:DropDownList></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow runat="server">
