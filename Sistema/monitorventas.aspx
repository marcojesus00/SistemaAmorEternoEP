...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" HorizontalAlign="left">
            <div>
                <h4 style="width: 100%; text-align: center">Monitor de Ventas</h4>
            </div>
                    ...
                    <div class="col-sm-4 col-d-3 col-lg-2">
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <label for="txtFechalb" class="input-group-text" style="width: 75px">Fecha inicial</label>
                            </div>
                        ...
                        <div class="input-group input-group-sm">
                            <div class="input-group-prepend">
                                <label for="txtFechalb" class="input-group-text" style="width: 75px">Fecha final</label>
                            </div>
                            <asp:TextBox TextMode="Date" class="form-control form-control-sm" ID="TextFinalDate" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="container-fluid" style="background-color: white; position: absolute; left: 0; top: 0; bottom: 0" id="PanelProductosApp" runat="server" visible="false">
            ...
            <asp:LinkButton ID="btnCerrarPanelProductosApp" runat="server" Style="position: absolute; right: 5%; top: 38px; font-size: x-large"><i class="far fa-times-circle text-secondary"></i></asp:LinkButton>
        </div>
                   ...
                   <div class="row" style="background-color: white; padding-top: 15px;">
                       <div class="col-12">
                           <div class="input-group input-group-sm">
                               ...
                               <asp:TextBox ID="txtmotivoCambSta" runat="server" CssClass="form-control form-control-sm" placeholder="Motivo" TextMode="SingleLine" />
