...
<i class="bi bi-geo-alt-fill"></i>
        ...
        <div class="col-lg-5">
            ...
            <div class="table-responsive">
                <asp:GridView ID="DetailsControl" CssClass="table  table-sm table-striped table-hover table-bordered border-primary-subtle" runat="server" AutoGenerateRows="True" Visible="False">
                </asp:GridView>
            </div>
        </div>
    </div>
