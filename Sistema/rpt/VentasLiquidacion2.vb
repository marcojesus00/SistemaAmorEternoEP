...
Public Class VentasLiquidacion2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.VentasLiquidacion2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Liquida2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVentasLiquidacion2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentasLiquidacion2 = New VentasLiquidacion2()
        rpt.Site = Me.Site
        Return rpt
    End Function
