...
Public Class NoQuiereContinuar1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.NoQuiereContinuar1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNoQuiereContinuar1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NoQuiereContinuar1 = New NoQuiereContinuar1()
        rpt.Site = Me.Site
        Return rpt
    End Function
