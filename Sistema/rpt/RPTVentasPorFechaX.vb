...
Public Class RPTVentasPorFechaX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.RPTVentasPorFechaX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTVentasPorFechaX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTVentasPorFechaX = New RPTVentasPorFechaX()
        rpt.Site = Me.Site
        Return rpt
    End Function
