...
Public Class Clientes_Sin_Cobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.Clientes Sin Cobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClientes_Sin_Cobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Clientes_Sin_Cobro = New Clientes_Sin_Cobro()
        rpt.Site = Me.Site
        Return rpt
    End Function
