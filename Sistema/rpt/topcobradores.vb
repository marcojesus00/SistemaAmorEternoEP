...
Public Class topcobradores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema.topcobradores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedtopcobradores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As topcobradores = New topcobradores()
        rpt.Site = Me.Site
        Return rpt
    End Function
