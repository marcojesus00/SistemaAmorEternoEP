                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlDetails" runat="server" Style="display: none">
                                        <asp:GridView ID="DetailsControl" DataKeyNames="Codigo" CssClass="ChildGrid table table-sm table-striped table-hover table-bordered border-primary-subtle" runat="server" AutoGeneratedColumns="True">
                                            <Columns>
